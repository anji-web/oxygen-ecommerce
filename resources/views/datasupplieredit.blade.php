    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('updateSupplier')}}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="namaSupplier" type="text" class="form-control @error('namaSupplier') is-invalid @enderror" name="namaSupplier" value="{{ old('namaSupplier', $data->nama_supplier) }}" required autocomplete="namaBarang">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="telepon" type="text" class="form-control @error('telepon') is-invalid @enderror" name="telepon" value="{{ old('telepon',  $data->no_telp) }}" required autocomplete="stok">
