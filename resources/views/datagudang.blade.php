    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="createBagGudang">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="namaUserGudang" type="text" class="form-control @error('namaUserGudang') is-invalid @enderror" name="namaUserGudang" value="{{ old('namaUserGudang') }}" required autocomplete="namaUserGudang">
